...
class Inception:
    ...
    def print_scores(self, pred, k=1, only_first_name=True):
        """
...
if __name__ == '__main__':
    ...
    image_path = os.path.join(data_dir, '/home/krishna/tf/dnn_on_tf/images/hulk.jpg')

    # Use the Inception model to classify the image.
    pred = model.classify(image_path=image_path)

    # Print the scores and names for the top-10 predictions.
    model.print_scores(pred=pred, k=1)
